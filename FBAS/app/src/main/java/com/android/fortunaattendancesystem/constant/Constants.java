...
//    public static final String VALIDATION_TEMPLATE_DOWNLOAD="2100";
    ...
    public final static String[] HOME_MENU_ITEM_NAMES = {"Employee Enrollment", "Finger Enrollment", "Finger Enrollment (Aadhaar Mode)", "Employee Attendance", "Smart Card", "Master Data Entry", "Programmable In-Out", "Settings(Finger Enrollment Mode)", "Server Settings", "Hardware Settings", "Excel Export/Import", "User Creation", "Delete User","Server Settings","Wiegand Settings","View Settings","Log Out"};
...
//    public final static int IDENTIFICATION_RESTART_DELAY=1000;
    ...
    public final static int IDENTIFICATION_RESTART_DELAY=500;//2500//1000
    ...
    public final static float XXX2=4000;
