...
//    }
    ...
    public void onRemoveUserClick(View view) {
        try {
            ...
            if (selectedIndex != -1) {
                showCustomConfirmDialog(false, "User Deletion", "Do You Want To Delete User ?");
            } else {
                        ...
                        if (ret == 0) {
                            ...
                            if (ret == 0) {
                                ...
                                if (autoId != -1) {
                                    ...
                                    if (deletionStatus != -1) {
                                        deletionStatus = dbComm.deleteFingerRecordByEmpId(autoId);
                                        if (deletionStatus != -1) {
                ...
                if (status != -1) {
                    ...
                    if (status != -1) {
                        ...
                        if (status == ErrorCodes.MORPHO_OK) {
                            ...
                            Toast.makeText(DeleteUserActivity.this, "Failed to delete template from morpho", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(DeleteUserActivity.this, "Failed to delete template from sqlite", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
    ...
    //    private class AsyncTaskLoadMorphoDatabase extends AsyncTask<Void, Void, Void> {
//
...
//            mypDialog = new ProgressDialog(DeleteUserActivity.this);
//            mypDialog.setMessage("Loading Database Wait...");
...
//                Long noOfUsedRecords = new Long(10);
//                ret =morphoDatabase.getNbUsedRecord(noOfUsedRecords);
//                if (ret == 0 && noOfUsedRecords > 0) {
//                    loadDatabaseItem();
//                    status = true;
//                }
//            }
