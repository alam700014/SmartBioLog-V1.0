...
//        }
        ...
        //================================= View Settings , Wiegand Settings,Server SettingsLog Out  =====================================//
...
//        }
        ...
        if (isAdmin != null && isAdmin.trim().equals("Y")) {
            drawerItem[index++] = new DrawerItem(R.drawable.pointer, Constants.HOME_MENU_ITEM_NAMES[13]);
        }
        ...
        if (isAdmin != null && isAdmin.trim().equals("Y")) {
            drawerItem[index++] = new DrawerItem(R.drawable.pointer, Constants.HOME_MENU_ITEM_NAMES[14]);
        }


        //================================= View Settings =====================================//

        drawerItem[index++] = new DrawerItem(R.drawable.pointer, Constants.HOME_MENU_ITEM_NAMES[15]);

        //================================= Log Out ==============================================//

        drawerItem[index++] = new DrawerItem(R.drawable.pointer, Constants.HOME_MENU_ITEM_NAMES[16]);
